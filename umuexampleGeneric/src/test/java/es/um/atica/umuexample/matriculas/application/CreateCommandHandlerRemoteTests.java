...
class CreateCommandHandlerRemoteTests extends SpringConfigurationTest{
    ...
    private static final String ID_MATRICULA_INEXISTENTE = "10497172-c376-11ed-afa1-0242ac120555";
    ...
    void crear_matricula_ya_existe() throws Exception {
    	...
    	CrearMatriculaCommand add = CrearMatriculaCommand.of(ID_MATRICULA, "TestMatricula 1", "Telematica", "30497182-c376-11ed-afa1-0242ac220002");
        // Cuando se lanza el comando
